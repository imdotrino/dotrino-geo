...
const READ_PER_MIN = Number(process.env.GEO_RL_READ_PER_MIN || 600);   // 10/s sostenido
const WRITE_PER_MIN = Number(process.env.GEO_RL_WRITE_PER_MIN || 120); // 2/s sostenido
const DISABLED = process.env.GEO_RL_DISABLED === '1';
...
// igual. Si se expone el server sin proxy, poné GEO_TRUST_PROXY=0 y se usa el
// socket. (XFF es spoofeable; esto es amortiguación best-effort, no seguridad.)
const TRUST_PROXY = process.env.GEO_TRUST_PROXY !== '0';
